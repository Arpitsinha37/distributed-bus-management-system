...
import { FaArrowLeft, FaClock } from 'react-icons/fa'; // Assuming we can use react-icons if it's installed, let's use lucide-react just in case, but old project used react-icons. The storefront project has lucide-react. I'll use lucide-react.
