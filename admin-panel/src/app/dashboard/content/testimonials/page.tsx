...
export default function TestimonialsPage() {
    ...
    const fetchAll = async () => {
        try { setError(null); const res = await apiGet<Testimonial[]>('/cms/testimonials', accessToken!); setData(res || []); } catch (err: any) { setError(err.message || 'Failed to load'); } setLoading(false);
    };
