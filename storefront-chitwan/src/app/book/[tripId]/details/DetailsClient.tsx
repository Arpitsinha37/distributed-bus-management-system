              ...
              <div className="max-w-xl w-full flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-4">
                      <button
                          ...
                          disabled={submitting}
                          className="bg-[#DC143C] hover:bg-red-700 disabled:bg-gray-400 text-white font-bold py-2.5 px-8 rounded-lg text-sm shadow-md transition-transform active:scale-95"
                      >
