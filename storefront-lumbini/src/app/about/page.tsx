...
export const metadata: Metadata = {
  title: 'About Us | Lumbini Express',
  description: 'Learn about our premium bus travel experience between Kathmandu and Lumbini.',
};
      ...
      <div className="max-w-[90rem] mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-20 items-center">
          <div className="md:col-span-6">
            ...
            <h1 className="text-4xl md:text-6xl font-display font-bold text-white mb-6 leading-tight">
              Connecting the capital to the sacred land
            </h1>
            <p className="text-lg text-white/60 leading-relaxed mb-8 max-w-lg">
              We started Lumbini Express with a mission: to make the pilgrimage to the Birthplace of Lord Buddha comfortable, affordable, and dignified. Every journey we operate is a bridge between the modern capital and ancient spirituality.
            </p>
            ...
            {[
              {
                ...
                desc: 'Every vehicle undergoes rigorous daily checks. Our drivers are the most experienced on the Kathmandu–Lumbini highway.',
              },
              {
                icon: Heart,
                title: 'Pilgrim-First Comfort',
                desc: 'We believe pilgrims and travelers should arrive feeling refreshed. That means recliner seats, AC, and a smooth ride.',
              },
              {
                icon: Mountain,
                title: 'Respect the Journey',
                desc: 'We honor the sacred route to Lumbini, maintaining modern, lower-emission vehicles for a cleaner pilgrimage path.',
              },
            ].map((v, i) => (
        ...
        <div className="glass-static rounded-3xl p-12 relative overflow-hidden">
          ...
          <div className="relative z-10 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
             <div>
               <div className="text-4xl md:text-5xl font-display font-bold text-white mb-2">3+</div>
             ...
             <div>
               <div className="text-4xl md:text-5xl font-display font-bold text-white mb-2">30k+</div>
               <div className="text-sm text-brand-green uppercase tracking-widest font-semibold">Happy Travelers</div>
             </div>
             <div>
               <div className="text-4xl md:text-5xl font-display font-bold text-white mb-2">4.8</div>
