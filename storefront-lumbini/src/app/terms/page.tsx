...
export const metadata: Metadata = {
  title: 'Terms & Conditions | Lumbini Express',
  description: 'Terms and Conditions of use for Lumbini Express bus services.',
};

export default function TermsPage() {
  return (
    <main className="min-h-screen bg-white py-20 px-4">
      <div className="max-w-4xl mx-auto prose prose-amber lg:prose-xl">
