        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-100 via-blue-50 to-indigo-50 pt-[72px] pb-24 font-sans">
            ...
            <div className="print:hidden max-w-lg mx-auto px-4 pt-6 pb-4 flex items-center justify-between">
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-700 hover:to-emerald-700 text-white font-bold py-2.5 px-5 rounded-xl text-sm shadow-md shadow-teal-200 transition-all active:scale-95"
                    >
            ...
            <div ref={ticketRef} className="max-w-lg mx-auto px-4">
                <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100/50 relative">
                    ...
                    {/* Header Band */}
                    <div className="bg-gradient-to-r from-teal-600 via-emerald-600 to-teal-700 px-6 py-6 text-white relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            <div className="flex items-center justify-between mb-3">
                                <div className="flex items-center gap-2.5">
                                    <div className="w-10 h-10 rounded-lg border border-white/30 bg-white flex items-center justify-center font-bold text-teal-600 text-xs">BUS</div>
                                    <span className="text-sm font-bold tracking-wide uppercase opacity-90">Lumbini Bus</span>
                                </div>
                    ...
                    <div className="px-6 py-6 space-y-5">
                        ...
                        <div className="bg-teal-50 border border-teal-200 rounded-xl p-4 flex items-center justify-between">
                            <div>
                                <p className="text-xs text-teal-600 font-semibold uppercase tracking-wider mb-0.5">PNR / Booking Ref</p>
                                <p className="text-2xl font-mono font-black text-gray-900 tracking-wider">{booking.pnr || booking.bookingRef || '—'}</p>
                            </div>
                            <Receipt className="w-8 h-8 text-teal-300" />
                        </div>
                            ...
                            <div className="border-t border-gray-100 pt-4 grid grid-cols-2 gap-4">
                                {booking.boardingPoint && (
                                    <div>
                                        ...
                                        <p className="text-sm font-bold text-gray-900 flex items-center gap-1">
                                            <MapPin className="w-3 h-3 text-teal-500" /> {booking.boardingPoint}
                                        </p>
                                    </div>
                                )}
                                {booking.droppingPoint && (
                                    <div>
                                        ...
                                        <p className="text-sm font-bold text-gray-900 flex items-center gap-1">
                                            <MapPin className="w-3 h-3 text-teal-500" /> {booking.droppingPoint}
                                        </p>
                                    </div>
                                )}
                            </div>
