    ...
    <footer className="relative bg-slate-50">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-6">
          <p className="text-[0.6875rem] font-semibold text-[#D4831E] uppercase tracking-[0.2em] mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8">
          ...
          <div className="md:col-span-4">
            ...
            <p className="text-[0.875rem] text-slate-500 leading-relaxed max-w-xs">
              Premium bus travel between Kathmandu and Lumbini — the Birthplace of Lord Buddha. 
              Real-time seat selection, instant confirmations, and a comfortable journey through the Terai plains.
            </p>
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  href="/"
                  className="text-[0.875rem] text-slate-600 hover:text-[#D4831E] transition-colors duration-300"
                >
                  Book a Bus
                </Link>
              </li>
          ...
          <div className="md:col-span-4 md:text-right">
            ...
            <p className="text-[0.875rem] text-slate-500 mb-6">
              Book your journey to the Birthplace of Buddha in seconds.
            </p>
